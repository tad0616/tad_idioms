...
<{if $block.mean}>
  <div class="card card-body bg-light m-1"><{$block.mean}></div>
<{/if}>

<a href="<{$xoops_url}>/modules/tad_idioms/index.php?g2p=<{$block.g2p}>&show_sn=<{$block.show_sn}>#<{$block.show_sn}>" class="btn btn-sm btn-mini btn-info pull-right">more...</a>
